jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_ecommerce_store_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-ecommerce-store-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-ecommerce-store-plugin-install');
                button.addClass('button-primary vw-ecommerce-store-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-ecommerce-store-recommended-plugins .vw-ecommerce-store-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-ecommerce-store-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-ecommerce-store-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-ecommerce-store-recommended-plugins').css('display','none');
    });
