...
<div class="payment-retry ">
	...
	<!-- <div class="payment-retry-note">
		<span>Giao dịch chưa hoàn tất. Vui lòng thanh toán lại.</span>
	</div> -->
	...
	<form id="order_review" class="" method="post">
		...
		<table class="shop_table">
			<thead>
				<tr>
					...
					<th class="product-quantity"><?php esc_html_e( 'Duration', 'woocommerce' ); ?></th>
					<th class="product-quantity"><?php esc_html_e( 'From date', 'woocommerce' ); ?></th>
					...
					<?php foreach ( $order->get_items() as $item_id => $item ) : ?>
						...
						<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
							...
							<td class="product-quantity">
								<?php
									$time_unit = 'day';
									if ( $item->get_meta( 'time-unit' ) )
										$time_unit = $item->get_meta( 'time-unit' );
									echo $item->get_meta( 'duration' ) . ' ' . __( $time_unit, 'woocommerce' );
								?>
							</td>
							<td class="product-quantity">
							...
							<td class="product-subtotal">
								<?php //echo $order->get_formatted_line_subtotal( $item ); 
									echo wc_price( $item->get_meta( '_rental_price' ));
								?>
							</td>
							<td class="product-subtotal">
								<?php echo $order->get_formatted_line_subtotal( $item ); 
			...
			<tfoot>
				<?php if ( $totals ) : ?>
					<?php foreach ( $totals as $total ) : ?>
						<tr>
							<th scope="row" colspan="5"><?php echo $total['label']; ?></th><?php // @codingStandardsIgnoreLine ?>
		...
		<div id="payment" class="woocommerce-checkout-payment">
			...
			<div class="form-row">
				...
				<?php $order_button_text = "Đặt thuê"; ?>
				...
				<?php
					...
					// wp_nonce_field( 'woocommerce-process-checkout', 'woocommerce-process-checkout-nonce' );
