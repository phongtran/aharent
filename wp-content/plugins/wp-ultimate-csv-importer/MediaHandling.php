...
class MediaHandling{
	...
	public static function imageOptions(){	
		...
		$media_settings['overwriteImage'] = isset($_POST['overwriteImage']) ? sanitize_text_field($_POST['overwriteImage']) : '';
		$media_settings['file_name'] =isset( $_POST['file_name']) ?  sanitize_file_name($_POST['file_name']) : '';
		...
		$media_settings['thumbnail'] =isset( $_POST['thumbnail']) ?  sanitize_text_field($_POST['thumbnail']): ''; 	
		$media_settings['medium'] =isset( $_POST['medium']) ?  sanitize_text_field($_POST['medium']): '';		
		$media_settings['medium_large'] = isset( $_POST['medium_large']) ?  sanitize_text_field($_POST['medium_large']): '';		
		$media_settings['large'] = isset( $_POST['large']) ?  sanitize_text_field($_POST['large']): '';		
		$media_settings['custom'] = isset( $_POST['custom']) ?  sanitize_text_field($_POST['custom']): '';
		$media_settings['custom_slug'] =isset( $_POST['custom_slug']) ?  sanitize_text_field($_POST['custom_slug']): '' ;
		$media_settings['custom_slug'] = isset( $_POST['custom_width']) ?  sanitize_text_field($_POST['custom_width']): '';
		$media_settings['custom_height'] = isset( $_POST['custom_height']) ?  sanitize_text_field($_POST['custom_height']): '';
		$image_info = array(
