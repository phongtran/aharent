...
Read the blog to know about our [latest WordPress add-on](https://www.smackcoders.com/blog/category/wordpress-products) updates.

== Installation ==

1. First, install [CSV Importer & Exporter](https://wordpress.org/plugins/wp-ultimate-csv-importer/)
2. Extract the Import-woocommerce.zip in wordpress/wp-content/plugins using FTP or through plugin install in wp-admin.
...
= 1.1 =
* Upgrade now for import the custom taxonomies.
