...
class DefaultFormatter
{
    ...
    public function __construct($context)
    {
        ...
        $this->formatter->setTemplate(htmlspecialchars_decode($this->context->getOption("price_html_template",
            "{{price_html}}")));
    ...
    public function getHtml($priceHtml, ProcessedProductSimple $processedProduct)
    {
        ...
        $replacements = array(
            ...
            'regular_price_striked' => '<del>' . $this->priceFunctions->format($this->priceFunctions->getPriceToDisplay($product, array("price" => $product->get_regular_price()))) . '</del>',
        );
